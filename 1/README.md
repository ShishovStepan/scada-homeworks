...
2. В файле презентации расположить предложенные элементы SCADA и указать связи (связь начинается от оборудования)
4. Загрузить прикрепленный текстовый файл
5. Заполнить согласно требованиям к выполнению
...
1. Для всех объектов управления присвоены элементы управления
2. Для каждой единицы оборудования есть возможность управления как непосредственно около оборудования так и из диспетчерского пункта
3. Указана выбранная архитектура SCADA
4. *Выявлены минимум три риска при работе SCADA
5. *Указаны методы предупреждения всех выявленных рисков
